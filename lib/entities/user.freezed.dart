...
class _$UserImpl implements _User {
  _$UserImpl(
      {this.id,
      @UserdataConverter() final List<UserData>? userData,
  ...
  @override
  String toString() {
    return 'User(id: $id, userData: $userData, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id,
      const DeepCollectionEquality().hash(_userData), createdAt, updatedAt);
